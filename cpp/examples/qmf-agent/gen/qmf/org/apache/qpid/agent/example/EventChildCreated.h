...
#ifndef _MANAGEMENT_CHILDCREATED_
#define _MANAGEMENT_CHILDCREATED_
...
namespace example {
 ...
 class EventChildCreated : public ::qpid::management::ManagementEvent
{
  private:
  ...
  public:
    writeSchemaCall_t getWriteSchemaCall(void) { return writeSchema; }
     ...
     EventChildCreated(const std::string& _childName);
     ~EventChildCreated() {};
...
#endif  /*!_MANAGEMENT_CHILDCREATED_*/
